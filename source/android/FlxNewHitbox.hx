...
class FlxNewHitbox extends FlxSpriteGroup
{
	...
	public function new():Void
	{
		...
		add(buttonShift = createHint(FlxG.width / 3, 0, Std.int(FlxG.width / 3), Std.int(FlxG.height /5), 0xFF00FF));
		add(buttonCtrl = createHint((FlxG.width / 3) + (FlxG.width / 3), 0, Std.int(FlxG.width / 3), Std.int(FlxG.height /5), 0x00FF00));
