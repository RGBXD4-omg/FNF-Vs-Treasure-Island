...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Add Enemie', "Value 1: Enemy you wish to add\n\nOn Value 1, Enemie name."],
		['Enemie Attack', "Value 1: Enemy to attack\nValue 2: Attack to be performed\n\nOn Value 1, Enemie name\nOn Value 2, Int"],
		['Add Text', "Value 1: Text to display\nValue 2: Size\n\n If the Size is equal to or less than 0, the text will disappear."]
	];
	...
	**/
	...
	function addSongUI():Void
	{
		...
		if(skin == null) skin = '';
		noteSkinInputText = new FlxUIInputText(player1DropDown.x, player1DropDown.y + 50, 150, skin, 8);
